...
const Duration = (props) => {
  ...
  const duration = ['Choose workspace type', 'Hourly', 'Daily', 'Monthly']

  return (
    <main className='lg:p-10 lg:h-screen md:p-10 sm:p-10'>
      <h1 className='text-2xl font-normal py-1'>
        {t('Set the duration of your space')}
      </h1>
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          console.log(props.data, "props.data before");
          props.next(values, props?.data?.category === 2 ? 'allowNext' : 'skipNext')
          setSubmitting(true)
          setTimeout(() => {
            setSubmitting(false)
          }, 500)
            ...
            <div className='flex flex-col '>
              <div className='my-4 flex flex-col w-full'>
                ...
                <Field
                  ...
                  name='type'
                  id='type'
                  className='border-2 border-[#F6F6F6] outline-none cursor-pointer lg:w-full lg:h-[56px] lg:py-0 rounded text-left focus:border-[#0559FD] 
                    md:h-[50px] sm:h-[50px] sm:py-3 my-3'
                >
                  {duration.map((x) => {
              ...
              <button
                type='submit'
                className='border-0 rounded hover:bg-[#0559FD] bg-[#D4D4D4] text-white w-[80px] h-[52px] lg:mt-5 md:mt-14 sm:mt-14 text-center'
              >
                {t('Next')}
              </button>
            </div>
