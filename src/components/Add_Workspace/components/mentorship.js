  ...
  return (
    <main className='lg:p-10 lg:h-screen md:p-10 sm:p-10'>
      <h1 className='text-[20px] font-normal py-1'>
        {t('Let’s get you connected with mentee')}
      </h1>
      <p className='font-semibold text-[20px] '> 5/11 </p>

      <Formik
        initialValues={props.data}
        validationSchema={Yup.object().shape({
          mentorship_available: Yup.string().required(
            'Select mentorship available'
          ),
        })}
      ...
      >
        {({ values }) => (
          <Form className='grid grid-cols-1 content-center lg:mt-10 md:mt-20 sm:mt-20 '>
            <h1 className='lg:text-4xl lg:w-[400px]'>
              Are you open to mentorship?
            </h1>
            <div className='py-10 flex flex-col space-y-5'>
              <label className='flex items-center gap-3 text-[18px]'>
                <Field type='radio' name='mentorship_available' value='1' />
                Yes
              </label>

              <label className='flex items-center gap-3 text-[18px]'>
                <Field type='radio' name='mentorship_available' value='0' />
                No
              </label>
            </div>
            ...
            <button
              type='submit'
              className='border-0 rounded hover:bg-[#0559FD] bg-[#D4D4D4] text-white w-[80px] h-[52px] lg:mt-0
            ...
            <section
              className='progressbar lg:flex lg:item-center lg:justify-center lg:gap-4 lg:pt-16 md:pt-24
              md:flex md:justify-between md:items-center md:gap-4 sm:flex sm:justify-between sm:items-center
              sm:gap-4 sm:pt-20 '
            >
              <div className=' lg:w-[90%] border-b-2 border-[#F2F2F2] relative top-0 md:w-[90%] sm:w-[90%] '>
                <div className='w-[30%] border-b-2 border-blue-500 absolute'></div>
              </div>
              ...
              <div className='btns flex space-x-4'>
                ...
                >
                  ...
                  >
                    <path
                      d='M10.9756 16.0248L7.37559 12.4248C7.31971 12.3691 7.27538 12.3029 7.24513 
                                            12.23C7.21489 12.1571 7.19932 12.0789 7.19932 12C7.19932 11.9211 7.21489 
                                            11.8429 7.24513 11.77C7.27538 11.6971 7.31971 11.6309 7.37559 11.5752L10.9756 
                                            7.9752C11.0314 7.91942 11.0976 7.87516 11.1705 7.84497C11.2434 7.81478 11.3215 
                                            7.79924 11.4004 7.79924C11.4793 7.79924 11.5574 7.81478 11.6303 7.84497C11.7032 
                                            7.87516 11.7694 7.91942 11.8252 7.9752C11.881 8.03099 11.9252 8.09721 11.9554 
                                            8.1701C11.9856 8.24299 12.0011 8.32111 12.0011 8.4C12.0011 8.47889 11.9856 
                                            8.55701 11.9554 8.6299C11.9252 8.70279 11.881 8.76902 11.8252 8.8248L9.24879 
                                            11.4H16.2004C16.3595 11.4 16.5121 11.4632 16.6247 11.5757C16.7372 11.6883 
                                            16.8004 11.8409 16.8004 12C16.8004 12.1591 16.7372 12.3117 16.6247 12.4243C16.5121 
                                            12.5368 16.3595 12.6 16.2004 12.6H9.24879L11.8252 15.1752C11.9379 15.2879 12.0011 
                                            15.4407 12.0011 15.6C12.0011 15.7593 11.9379 15.9121 11.8252 16.0248C11.7125 16.1375 11.5597 16.2008 11.4004 16.2008C11.2411 16.2008 11.0883 16.1375 10.9756 16.0248ZM2.40039 12C2.40039 14.5461 3.41182 16.9879 5.21217 18.7882C7.01251 20.5886 9.45431 21.6 12.0004 21.6C14.5465 21.6 16.9883 20.5886 18.7886 18.7882C20.589 16.9879 21.6004 14.5461 21.6004 12C21.6004 9.45392 20.589 7.01213 18.7886 5.21178C16.9883 3.41143 14.5465 2.4 12.0004 2.4C9.45431 2.4 7.01251 3.41143 5.21217 5.21178C3.41182 7.01213 2.40039 9.45392 2.40039 12ZM12.0004 20.4C10.8973 20.4 9.80498 20.1827 8.78585 19.7606C7.76671 19.3384 6.84071 18.7197 6.06069 17.9397C5.28068 17.1597 4.66194 16.2337 4.2398 15.2145C3.81766 14.1954 3.60039 13.1031 3.60039 12C3.60039 10.8969 3.81766 9.8046 4.2398 8.78546C4.66194 7.76633 5.28068 6.84032 6.06069 6.0603C6.84071 5.28029 7.76671 4.66155 8.78585 4.23941C9.80498 3.81727 10.8973 3.6 12.0004 3.6C14.2282 3.6 16.3648 4.485 17.9401 6.0603C19.5154 7.63561 20.4004 9.77218 20.4004 12C20.4004 14.2278 19.5154 16.3644 17.9401 17.9397C16.3648 19.515 14.2282 20.4 12.0004 20.4Z'
                      fill='#FFFFFF'
                    />
                  </svg>
                </button>
