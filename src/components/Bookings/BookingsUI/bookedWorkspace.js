...
const BookedWorkspace = () => {
  ...
  const [bookedSpaces, setBookedSpaces] = useState(null)
  ...
  return (
    <>
      ...
      <section className='flex flex-col xl:w-[87%] lg:w-[84%] ml-auto'>
        <DashboardHeader
          icon={
        ...
        {totalWorkspaces !== 0 ? (
          layout ? (
            <section className='flex flex-col gap-2 lg:mx-5 sm:mx-2'>
              {content}
            </section>
          ) : (
...
export default BookedWorkspace
