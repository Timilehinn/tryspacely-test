...
const Review = ({
  ...
  const getDate = created_at?.split('T')[0]
  ...
  return (
    <>
      <div className='relative w-[100%]'>
        <div className='download sm:w-[100%] md:w-[80%] mt-[10px] bg-[#fff] rounded border p-[10px]'>
          <div className='flex justify-between items-start'>
            <div className='flex justify-start items-center space-x-2 mb-[10px]'>
              <div className='w-[30%] h-[100px] rounded overflow-hidden flex justify-center items-center'>
                <img
              ...
              <div>
                <div className='font-400 font-[Plus Jakarta Display] text-[#141115] text-[18px]'>
                  {workspace?.name}
                </div>
                <div className='font-400 font-[Plus Jakarta Display] text-[#5B585B] text-[10px]'>
                  {workspace?.address}
                </div>
              </div>
            </div>
          ...
          <div className='flex space-x-2 items-center'>
            ...
            <span className='font-400 text-[#5B585B] text-[10px] font-[Plus Jakarta Display]'>
              {moment(getDate).startOf('day').fromNow()}
            </span>
            <div className='ml-[10px] flex items-center'>
              ...
              <div className='ml-[5px] text-[#F9DC5C]'>{rating}</div>
            </div>
          </div>
          ...
          {toggleOption && (
            <div
              ref={ref}
              className='absolute w-[120px] sm:right-[0px] md:right-[18%] top-[15%]  z-10 flex flex-col md:p-[10px] sm:p-[5px] bg-[#FFFFFF] space-y-4 download rounded'
            >
              <Link
                to={`/user/bookings/bookingdetails/${workspaces_id}`}
