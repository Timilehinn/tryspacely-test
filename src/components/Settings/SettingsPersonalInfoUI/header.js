...
const Header = ({ user, accountType }) => {
  ...
  const [hamBurgerOpen] = useState(true)
    ...
    <div className='w-full '>
      ...
      >
        <div className='flex justify-center items-center gap-2 '>
          ...
          <img
            className='text-[#0559FD] w-10'
            src='https://trybookings-assets.s3.eu-west-2.amazonaws.com/Settings.svg'
            alt='settings'
          />
          <h1 className='text-[#141115] text-[19px] font-medium xl:block md:block sm:hidden'>
            {' '}
            {t('Settings')}{' '}
          </h1>
        </div>
