...
import { setSignupAddress } from '../../slices/authRelated'
import CreateWorkspaceAddress from '../Add_Workspace/auto_complete'
import { useEffect } from 'react'

const Workspace_Address = (props) => {
  ...
  return (
    <main
      className='lg:grid lg:content-center lg:justify-center text-center lg:h-screen
        lg:w-2/4 lg:mx-auto lg:px-0 md:w-2/4 md:py-14 md:ml-44 sm:px-10 sm:py-14 '
    >
      <h1 className='lg:text-2xl md:text-3xl sm:text-2xl font-semibold '>
        Address
      </h1>
      <p className='lg:text-lg md:text-xl sm:text-xl'>
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          dispatch(setSignupAddress(values))
          props.next(values)
          setSubmitting(true)
          setTimeout(() => {
            setSubmitting(false)
      ...
      >
        {({ values, handleSubmit, handleChange }) => (
          ...
          >
            ...
            >
              <div className='grid grid-cols-1 gap-2'>
                ...
                <input
                  ...
                  value={values.city}
                  className='border-2 border-[#F6F6F6] outline-none lg:w-[150px] lg:py-3 rounded text-left flex flex-col
              ...
              <div className='grid grid-cols-1 gap-2'>
                ...
                <Field
                  as='select'
                  name='state'
                  className='border-2 border-[#F6F6F6] outline-none cursor-pointer lg:w-[150px] lg:py-3 rounded text-left
                focus:border-[#0559FD] md:w-[150px] md:p-2 sm:w-[150px]
                sm:py-3'
                >
            ...
            <hr className='border-[#D4D4D4] w-full lg:mt-36 md:mt-20 sm:mt-16' />
            <div className='flex justify-between align-middle items-center py-4 '>
              ...
              <div className='flex lg:ml-auto gap-4'>
                <button
                  ...
                  className='bg-[#0559FD] rounded p-1 '
                >
                  <svg
                    width='24'
                    height='24'
                ...
                <button type='submit' className='bg-[#0559FD] rounded p-1 '>
                  <svg
                    width='24'
                    height='24'
                    viewBox='0 0 24 24'
...
export default Workspace_Address
